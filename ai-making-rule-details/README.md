...
This folder contains the detailed stage instructions used by `ai-making-rules/core-workflow.md`.
...
- `inception/project-context-detection.md`
- `inception/existing-design-review.md`
...
- `inception/work-units-generation.md`
...
- `operations/prototype-feedback-capture.md`
